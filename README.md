...
スマホブラウザでホーム画面に追加しやすいよう、Web App Manifest、アプリアイコン、テーマカラー、基本的なService Workerを設定しています。

- アプリ名はホーム画面で「きろくま」と表示されます。
- Service Workerはアプリシェルとアイコンを軽くキャッシュします。
- Web Push通知や完全なオフライン対応は含みません。
